...
class SortedArraySetTest {
  ...
  class TestCasesForCopyOfMethod {
    ...
    @Test
    @DisplayName("raises an exception with an empty SortedLinkedSet")
    void givenAEmptySetWhenCopyOfThenTheNewSetIsAlsoEmpty() {
      ...
      // Act & Assert
      Exception exception = assertThrows(IllegalArgumentException.class, () -> SortedArraySet.copyOf(set));
      String expectedMessage = "initial capacity must be greater than 0" ;
  ...
  class TestCasesForMethodDelete {
    ...
    void whenASetHasOneElementWhenDeleteADifferentElementThenTheSetRemainsUnchanged() {
      // Arrange
      int element = 1 ;
      SortedSet<Integer> set = SortedArraySet.from(List.of(element));
    ...
    void whenASetHasFourElementWhenDeleteADifferentElementThenTheSetRemainsUnchanged() {
      // Arrange
      SortedSet<Integer> set = SortedArraySet.from(List.of(4,3,5,0));
    ...
    void whenASetHasThreeElementWhenDeleteThenTheFirstElementIsDeleted() {
      // Arrange
      SortedSet<Integer> set = SortedArraySet.from(List.of(4,3,5));
  ...
  class TestCasesForMethodMinimum {
    ...
    void whenTheSetHasOneElementThenThatElementIsReturned() {
      // Arrange
      double element = 5.5 ;
      SortedSet<Double> set = SortedArraySet.from(List.of(element));
    ...
    void whenTheSetHasSeveralElementsThenTheMinimumOneIsReturned() {
      // Arrange
      SortedSet<Double> set = SortedArraySet.from(List.of(5.6, 0.2, 4.9, 3.7));
  ...
  class TestCasesForMethodUnion {
    ...
    void whenTheSecondSetIsEmptyThenReturnsTheFirstSet() {
      // Arrange
      SortedSet<Integer> set1 = SortedArraySet.from(List.of(5,2,3,9)) ;
    ...
    void whenTheFirstSetIsEmptyThenReturnsTheSecondSet() {
      ...
      SortedSet<String> set2 = SortedArraySet.from(List.of("blue", "green", "white"));
    ...
    void whenTheSetsAreEqualsThenReturnsOneOfThem() {
      // Arrange
      SortedSet<String> set1 = SortedArraySet.from(List.of("red", "white", "blue")) ;
      SortedSet<String> set2 = SortedArraySet.from(List.of("blue", "red", "white"));
  ...
  class TestCasesForMethodIntersection {
    ...
    void whenTheSetsContainTheSameElementThenReturnsASetWithThatElement() {
      // Arrange
      SortedSet<Double> set1 = SortedArraySet.from(List.of(1.0));
      SortedSet<Double> set2 = SortedArraySet.from(List.of(1.0));
    ...
    void whenTheSetsShareAnElementThenReturnsTheIntersectionSet() {
      ...
      SortedSet<String> set2 = SortedArraySet.from(List.of("blue", "red", "white", "pink"));
  ...
  class TestCasesForMethodDifference {
    ...
    void whenTheSetsContainADifferentElementThenReturnsASetWithTheElementOfTheFirstSet() {
      // Arrange
      SortedSet<Double> set1 = SortedArraySet.from(List.of(2.0));
      SortedSet<Double> set2 = SortedArraySet.from(List.of(1.0));
