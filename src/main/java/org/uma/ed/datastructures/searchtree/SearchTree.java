...
public interface SearchTree<K> {
  ...
  /**
   * Performs a delete, update, or insert operation on the search tree based on the provided parameters.
   ...
   * If the key is not present and the insert flag is true, the key is inserted into the search tree.
   *
